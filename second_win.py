...
class TestWin(QWidget):
    ...
    def initUI(self):
        ...
        self.text_timer.setObjectName("timer")

        self.line_name = QLineEdit(txt_hintname)
        self.line_name.setPlaceholderText(txt_hintname)
        self.line_name.setObjectName("input")

        self.line_age = QLineEdit(txt_hintage)
        self.line_age.setPlaceholderText(txt_hintage)
        self.line_age.setObjectName("input")

        self.line_test1 = QLineEdit(txt_hinttest1)
        self.line_test1.setPlaceholderText(txt_hinttest1)
        self.line_test1.setObjectName("input")

        self.line_test2 = QLineEdit(txt_hinttest2)
        self.line_test2.setPlaceholderText(txt_hinttest2)
        self.line_test2.setObjectName("input")

        self.line_test3 = QLineEdit(txt_hinttest3)
        self.line_test3.setPlaceholderText(txt_hinttest3)
        self.line_test3.setObjectName("input")

        self.l_line = QVBoxLayout()
        self.r_line = QVBoxLayout()
        self.h_line = QHBoxLayout()

        # tweak spacing and margins
        self.l_line.setSpacing(8)
        self.r_line.setContentsMargins(20, 20, 20, 20)
        self.l_line.setContentsMargins(20, 20, 20, 20)
        ...
        # apply a local stylesheet for consistent look if parent didn't supply one
        self.setStyleSheet("""
        QWidget { background: #f7f9fc; }
        QLabel#timer { color: #1f618d; }
        ...
        QLineEdit#input { background: white; border: 1px solid #cfd8dc; padding: 6px; border-radius: 4px; }
        """)
